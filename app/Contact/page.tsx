...
//             <Link href='#' className="h-[5%] w-[50%]"> <Socials image={Call} details="071 131 1050" /></Link>
//             <Link href='#' className="h-[5%] w-[50%]"> <Socials image={WhatsApp} details="071 131 1050" /></Link>
//             <Link href='#' className="h-[5%] w-[50%]">  <Socials image={Github} details="DerrickDeshoe" /> </Link>
//             <Link href='#' className="h-[5%] w-[50%]">  <Socials image={LinkedIn} details="Derrick Deshu" /> </Link>
//             <Link href='#' className="h-[5%] w-[50%]"> <Socials image={Email} details="derrickdeshoe71@gmail.com" /></Link>
//           </div>
